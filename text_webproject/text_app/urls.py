...
urlpatterns = [
    ...
    path('snippet/detail/<int:snippet_id>', views.SnippetDetailView.as_view()),
    path('snippet/update/<int:snippet_id>', views.SnippetUpdateView.as_view()),
    path('snippet/delete', views.SnippetDeleteView.as_view()),
    path('tag/list', views.TagListView.as_view()),
    path('snippet/list_by_tag/<int:tag_id>', views.SnippetListByTag.as_view()),
]
